    ...
    <Box>
         <Box p='1rem' borderRadius='8px' bg='white' alignItems='center' display='flex' justifyContent='space-between' >
            <Box border='1px solid #333' p='.5rem' alignItems='center' display='flex'>
                <Text>Academy &nbsp;</Text>
                <Text display='inline-block' fontWeight='700' borderLeft='1px solid #333'>&nbsp;Add Academy</Text>
            </Box>
        </Box>   
        ...
        <Box w='full' display='flex' flexDir={['column','row']} p='1rem' justifyContent='space-between' >
            ...
            <Box w={['full','50%']}  p='1rem 2rem' mt='1rem' >
                ...
                <Box  borderRadius='8px' mt='.5rem' p='1rem' bg='#fff'>
                    <InputValue placeholder='Academy Name' name="name"
          value={formState.name}
          onChange={handleInputChange} text='Academy Name:'/>
                    <InputValue placeholder='Year Founded'  name="founded"
                    value={formState.founded}
                    type='date'
                    onChange={handleInputChange} text='Year Founded:'/>
                    <InputValue placeholder='number' name="principal" value={formState.principal} onChange={handleInputChange} text='Academy Princpal:'/>
                ...
                <Text mt='1rem' fontWeight='700'>Academy Statistics</Text>
                <Box  borderRadius='8px' mt='.5rem' p='1rem' bg='#fff'>
                    <InputValue placeholder='Has Graduated' name='graduatedCount' value={formState.graduatedCount} onChange={handleInputChange}  text='Has Graduated:'/>
            ...
            <Box w={['full','50%']}  p='1rem 2rem' mt='1rem' >
                ...
                <Text fontWeight='700'>Academy Logo</Text>
                <Box  borderRadius='8px' mt='.5rem' p='.5rem' bg='#fff'>
                    <InputValue 
                    placeholder='Logo Url' 
                    //type='file' 
                    text='Add Academy Logo'
                    name='logoUrl' 
                ...
                <Text mt='1rem' fontWeight='700'>More Academy Information</Text>
                <Box  borderRadius='8px' mt='.5rem' p='1rem' bg='#fff'>
                    ...
                    <InputValue placeholder='Academy Description'   text='Academy Description:' name='description' value={formState.description} onChange={handleInputChange} />
                </Box>
