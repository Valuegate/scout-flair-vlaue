...
const Addplayers = () => {
  ...
  const [formState, setFormState] = useState(initialFormState);
    ...
    const mutation = useMutation(Addplayers);
    ...
    <Box>
        ...
        <Box w='full' display='flex' flexDir={['column','row']} p='1rem' justifyContent='space-between' >
          ...
          onChange={handleInputChange} text='Date of Birth:' type='date'/> */}
                    ...
                    {userType==='Admin'&& <InputValue placeholder='User Type' name="UserType" value={formState.userType} onChange={handleInputChange} text='User Type:'/>
                    }
