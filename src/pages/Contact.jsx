     ...
     <Box w='full'h='100%' bg='#1A1818'>
        <Box w='full'h={['100%','100%','100vh']} bg='#1A1818' display='flex' p='2rem' alignItems='center' justifyContent='space-betweeen' flexDirection={['column','row']}>
            <Box w={['full','50%']} p={['0rem','2rem']}>
                <Text fontSize={['3.5rem','4rem']} fontWeight='700' color='#BC9531' >Write us today</Text>
                <Button _hover={{
                    color:'#C99C27',
                    background:'#232B35',
         ...
         <Box w='full'h={['100%','100%','100vh']} bg='#1A1818' display='flex' p='2rem' alignItems='center' justifyContent='space-betweeen' flexDirection={['column','row']}>
            ...
            <Box w={['full','50%']} p={['0rem','2rem']}>
                <Text fontSize={['2.5rem','36px']} fontWeight='700' color='#BC9531' >Write us a message</Text>
               <Box>
                <FormControl mt='1rem'>
                    <FormLabel color='#BC9531'>Name</FormLabel>
                    <Input type='text' color='#000' bg='#fff' borderRadius='25px' />
                </FormControl>
                <FormControl mt='1rem'>
                    <FormLabel color='#BC9531'>Email</FormLabel>
                    <Input type='mail' color='#000' bg='#fff' borderRadius='25px' />
                </FormControl>
                <FormControl mt='1rem'>
                    <FormLabel color='#BC9531'>Phone Number</FormLabel>
                    <Input type='text' color='#000' bg='#fff' borderRadius='25px' />
                </FormControl>
                <FormControl mt='1rem'>
                    <FormLabel color='#BC9531'>Message</FormLabel>
