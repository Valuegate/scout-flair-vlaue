...
const Cta = () => {
  return (
    <Box>
        <Box w='full'h={['100%','100%','100vh']}  mb={['1rem','']} display='flex' p={['1rem','2rem']} alignItems='center' justifyContent='center' flexDirection={['column','row']}>
            <Box w='75%' h='202px' display='flex' bg='#E5AA42' p='2rem' shadow='-9px 8px 0px #ddd' justifyContent='space-between' flexDirection={['column','row']} alignItems='center' >
                ...
                <Input mt={['1rem','']} mb={['1rem','']} type='text' w={['full','45%']} display='block' bg='#fff' placeholder='email' color='rgba(0, 0, 0, 0.34)' borderRadius='25px' />
                <Link  to='/login'>
