  ...
  return (
    <Box>
        <Box w='full'h={['100%','100%','100vh']} bg='#1A1818' display='flex' p='2rem' alignItems='center' justifyContent='center' flexDirection={['column','row']}>
            <Box w='75%' h='202px' display='flex' bg='#6DB7C0' p='2rem' shadow='-9px 8px 0px #ddd' justifyContent='space-between' flexDirection={['column','row']} alignItems='center' >
                ...
                <Button bg='#1A1818' fontSize={['1.2rem','24px']} borderRadius='none' color='#6DB7C0' p={['.75rem','1rem']} > Join Now</Button>
            </Box>
        </Box>
    </Box>
  )
